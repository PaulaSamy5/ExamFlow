...
- Name: audit.spec.js >> 1. Navigation & Page Load >> 1.4 /forgot-password page loads
- Location: audit.spec.js:74:3
...
Call log:
  - navigating to "http://localhost:5173/forgot-password", waiting until "load"
