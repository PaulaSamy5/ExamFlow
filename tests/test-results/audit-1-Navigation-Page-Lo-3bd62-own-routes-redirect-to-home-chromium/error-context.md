...
- Name: audit.spec.js >> 1. Navigation & Page Load >> 1.6 Unknown routes redirect to home
- Location: audit.spec.js:85:3
...
Call log:
  - navigating to "http://localhost:5173/this-route-does-not-exist-xyz", waiting until "load"
