  ...
  return (
    ...
    <div className="min-h-screen flex flex-col selection:bg-indigo-500/30">
      ...
      <main className={`flex-1 w-full ${
        ...
        location.pathname.startsWith('/session/') ? 'h-dvh w-full overflow-hidden' :
        (location.pathname.match(/^\/exams\/[^/]+$/) && location.pathname !== '/exams/new') ? 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[calc(100dvh-72px)] flex items-center justify-center overflow-hidden' : 
